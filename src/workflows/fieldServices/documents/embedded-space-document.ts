export const embeddedSpaceDocument = {
  title: 'Welcome',
  body: `
  <div class="my-doc">
  <style>
  ...
  <h1>Welcome!</h1>
  <p style="font-weight: 600;">We're excited to help you import your data to fieldservice.show.</p>
  </div>
  ...
  <div class="box">
  <h2>2. Import the Work Orders Data</h2>
  <p>Click "Import" and select the Work Orders data. Follow the mapping instructions in Flatfile to complete the import. Once the data has been mapped, it will be loaded into Flatfile's table UI, where validations and transformations have been applied.</p>
  </div>

  <div class="box">
  <h2>3. Validate and Transform Data</h2>
  <p>Make sure to verify that your data is correctly formatted and transformed by Flatfile. Flatfile will handle formatting dates, rounding amounts, and validating the existence of Work Orders for you! If there are any issues or errors, you can easily address them within Flatfile's user interface.</p>
  </div>

  <div class="box">
  <h2>4. Load Data into fieldservice.show</h2>
  <p>Once the data has been validated and transformed, use the “Push records to fieldservice.show” button to load data into the fieldservice.show application.</p>
  </div>

  <div class="box">
  <h2>5. Return to fieldservice.show</h2>
  <p>Once you have loaded the data from Flatfile to fieldservice.show, return to fieldservice.show and navigate to the Data Templates section within the application to view the Work Orders data that you have just loaded.</p>
  </div>
  ...
  <a href="https://github.com/FlatFilers/demo-apps/blob/main/src/workflows/fieldServices/actions/fieldServicesEmbed.ts" target="_blank" style="display: inline-flex; align-items: center; color: white; text-decoration: none; background-color: #000; padding: 16px 24px;">View on Github
  ...
  <div style="display: flex; flex-direction: column; background-color: #EFBC73; padding: 24px; border-radius: 8px; color: white; max-width: 320px;">

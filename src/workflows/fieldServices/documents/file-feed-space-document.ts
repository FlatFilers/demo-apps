export const fileFeedSpaceDocument = {
  title: 'Welcome',
  body: `
  <div class="my-doc">
  <style>
  ...
  <h1>Welcome!</h1>
  <p style="font-weight: 600;">We're excited to offer you a seamless, one-click experience for loading your data into fieldservice.show.</p>
  </div>
  ...
  <div class="box">
  <h2>1. Inspect the Automatically Uploaded File</h2>
  <p>Click "Files" in the left-hand sidebar. Here, you can view the original file that was automatically imported into Flatfile from Google Drive.</p>
  </div>

  <div class="box">
  <h2>2. Examine the Imported Customers Data</h2>
  <p>Click on the "Customers" workbook in the left-hand sidebar. This will display the data the remaining invalid values from the Google Drive file.</p>
  </div>

  <div class="box">
  <h2>3. Confirm the Data Load into fieldservice.show</h2>
  <p>As part of this process, we've automatically uploaded a file, mapped the data, and loaded all valid records into fieldservice.show.</p>
  </div>

  <div class="box">
  <h2>4. Return to fieldservice.show</h2>
  <p>Once you have inspected the files and data in Flatfile, return to fieldservice.show. Navigate to the Data Templates section within the application to view the Customers data that was just loaded.</p>
  </div>
  ...
  <a href="https://github.com/FlatFilers/demo-apps/blob/main/src/workflows/fieldServices/actions/fieldServicesFilefeed.ts" target="_blank" style="display: inline-flex; align-items: center; color: white; text-decoration: none; background-color: #000; padding: 16px 24px;">View on Github
  ...
  <div style="display: flex; flex-direction: column; background-color: #CD2659; padding: 24px; border-radius: 8px; color: white; max-width: 320px;">

export const projectSpaceDocument = {
  title: 'Welcome',
  body: `
  <div class="my-doc">
  <style>
  ...
  <div class="box">
  <h2>3. Import your Work Orders Data</h2>
  ...
  <div class="box">
  <h2>5. Load Data into fieldservice.show</h2>
  <p>Once the data has been validated and transformed, use the custom action on each sheet to load the data into fieldservice.show application.</p>
  </div>

  <div class="box">
  <h2>6. Return to fieldservice.show</h2>
  ...
  <a href="https://github.com/FlatFilers/demo-apps/blob/main/src/workflows/fieldServices/actions/fieldServicesProjects.ts" target="_blank" style="display: inline-flex; align-items: center; color: white; text-decoration: none; background-color: #000; padding: 16px 24px;">View on Github

export const projectSpaceDocument = {
  ...
  <div class="box">
  <h2>3. Import your Product Data</h2>
  <p>Click "Import" and select the Product data. Follow the mapping instructions in Flatfile to complete the import. Once the data has been mapped, it will be loaded into Flatfile's table UI, where validations and transformations have been applied.</p>
  </div>
  ...
  <div class="box">
  <h2>5. Load Data into PLM.Show</h2>
  <p>Once the data has been validated and transformed, use the custom action on each sheet to load the data into PLM.Show application.</p>
  </div>
  
  <div class="box">
  <h2>6. Return to PLM.Show</h2>
  ...
  <a href="https://github.com/FlatFilers/demo-apps/blob/main/src/workflows/plm/actions/plmProjectSpaceConfigure.ts" target="_blank" style="display: inline-flex; align-items: center; color: white; text-decoration: none; background-color: #000; padding: 16px 24px;">View on Github

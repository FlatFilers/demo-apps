export const embeddedSpaceDocument = {
  ...
  <a href="https://github.com/FlatFilers/hcm-show-config/blob/main/workflows/embedded/index.ts" target="_blank" style="display: inline-flex; align-items: center; color: white; text-decoration: none; background-color: #000; padding: 16px 24px;">View on Github

export const embeddedSpaceDocument = {
  ...
  <a href="https://github.com/FlatFilers/demo-apps/blob/main/src/workflows/plm/actions/plmEmbeddedSpaceConfigure.ts" target="_blank" style="display: inline-flex; align-items: center; color: white; text-decoration: none; background-color: #000; padding: 16px 24px;">View on Github
